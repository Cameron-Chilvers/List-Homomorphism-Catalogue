...
from unique_paths import unqiue_paths_dot_operator_horizontal
...
def return_unique_base(val):
    return [[[4, 0, 1]], [[0, 0, 1], [1, 0, 1], [2, 0, 1], [3, 0, 1], [4, 0, 1]]] # this is 1 by 5
...
print("Unique:", run_all_function(test_unique, return_unique_base, unqiue_paths_dot_operator_horizontal))